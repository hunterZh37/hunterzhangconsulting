/**
 * Central place for the links/contact details on the site.
 * Swap the placeholders (LinkedIn) whenever you're ready — everything
 * on the page reads from here.
 */
export const site = {
  name: "Hunter Zhang",
  ...
  agenticSchedulingRepo: "https://github.com/hunterZh37/agentic-scheduling",
  year: 2026,
};
